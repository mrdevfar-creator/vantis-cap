...
// Star icon component — reusable, unique gradient id per instance
const StarIcon = ({ id }) => (
  <svg
    className="w-5 h-5"
    viewBox="0 0 24 24"
...
export default function WantJoin() {
  return (
          ...
          <div>
            ...
            <div className="relative mt-8 rounded-full sm:mt-12">
              ...
              <div className="sm:absolute flex sm:right-1.5 sm:inset-y-1.5 mt-4 sm:mt-0">
                <button
                  type="button"
                  className="inline-flex items-center justify-center w-full px-5 py-5 text-sm font-semibold tracking-widest text-black uppercase transition-all duration-200 bg-white rounded-full sm:w-auto sm:py-3 hover:bg-red-500 hover:text-white"
                >
                  Find A Developer
                </button>
              </div>
