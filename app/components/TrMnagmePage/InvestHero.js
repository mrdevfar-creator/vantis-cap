      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 w-full">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-lg sm:text-xl leading-relaxed max-w-2xl mx-auto mb-10">
            We trade Forex, Gold, Crypto and Indices on your behalf using
            proven algorithmic strategies — so your money works while you
            don&apos;t. Starting from just <span className="text-white font-semibold">$50</span>.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
            <Link
              href="#plans"
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-black text-sm font-bold rounded-full hover:bg-amber-400 transition-all duration-200 hover:-translate-y-0.5 shadow-lg shadow-white/10 active:scale-95"
            >
              Start Investing
